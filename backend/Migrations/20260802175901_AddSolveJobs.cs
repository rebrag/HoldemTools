...
{
    /// <inheritdoc />
    public partial class AddSolveJobs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActingPos = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                    IsIcm = table.Column<bool>(type: "bit", nullable: false),
                    Board = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: true),
                    HasSeatMeta = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SolveJobs", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_SolveJobs_Status_Priority_CreatedAtUtc",
                table: "SolveJobs",
                columns: new[] { "Status", "Priority", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_SolveJobs_UserId",
                table: "SolveJobs",
                column: "UserId");
        }
